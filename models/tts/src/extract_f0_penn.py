...
for i, wave_filepath in tqdm(enumerate(wave_filepaths),  # noqa: B007
    ...
    if os.path.exists(pitch_filepath): continue  # noqa: E701, PTH110
...
for pitch_filepath in pitch_filepaths:
    ...
    if len(pitch_mel_) == 0: continue  # noqa: E701
