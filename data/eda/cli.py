...
import pandas as pd
from audio.amplitude import compute_silence_proportions, compute_snr_ratio, analyze_amplitude_trend
...
if __name__ == '__main__':
    ...
    try:
        ...
        logger.info(f"Dropped {len(raw_dataframe) - len(dataframe)} rows with missing values")  # noqa: E501
    ...
    silence_proporations, duration = zip(*silence_proporations_and_duration)
    ...
    bias, slope = zip(*amplitude_trends)
